  ...
  return (
    <div className="ai-sidebar">
      <div className="ai-sidebar-header">
        <span className="sidebar-title">AI Tools</span>
      ...
      <div className="ai-sidebar-content">
        ...
        {activeTab === 'generate' && (
          <div className="tab-generate">
            <div className="sidebar-section">
              <label className="section-label">Generate from topic</label>
              <input
                type="text"
            ...
            {postIdeas && (
              <div className="ideas-panel">
                <div className="ideas-header">
                  ...
                  <button className="ideas-dismiss" onClick={() => setPostIdeas('')}>✕</button>
                </div>
                <div className="ideas-content">{postIdeas}</div>
              </div>
            )}

            <div className="sidebar-section">
              <label className="section-label">Or use a framework</label>
        ...
        {activeTab === 'refine' && (
          <div className="tab-refine">
            ...
            <div className="sidebar-section">
              <label className="section-label">Quick actions</label>
            ...
            <div className="sidebar-section">
              <label className="section-label">Change tone</label>
              <div className="action-chips">
                {TONES.map(tone => (
                  <button
                    key={tone}
        ...
        {activeTab === 'templates' && (
          <div className="tab-templates">
            <div className="sidebar-section">
              <label className="section-label">Hook templates</label>
            ...
            <div className="sidebar-section">
              <label className="section-label">CTA / Endings</label>
              <div className="template-list">
                {ENDINGS.map((ending, i) => (
                  <button
                    key={i}
                    className="template-item ending"
        ...
        {activeTab === 'preview' && (
          <div className="tab-preview">
            <PostPreview content={content} image={composerImage} />
            <ContentScore content={content} firstComment={firstComment} />
          </div>
        )}
